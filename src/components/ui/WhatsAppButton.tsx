...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="whatsapp-pulse fixed bottom-6 right-6 z-50 flex h-[60px] w-[60px] items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-110 tap-feedback"
